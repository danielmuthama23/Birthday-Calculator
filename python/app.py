...
def birthday():
    ...
    # Birthday
        ...
        # Calculate day of the year for today
        today_day_of_year = today.timetuple().tm_yday

        # Calculate day of the year for the user's birthday
        birthday_day_of_year = datetime(today.year, month, day).timetuple().tm_yday

        # Calculate days until or since the user's birthday
        if today_day_of_year < birthday_day_of_year:
            days_until_birthday = birthday_day_of_year - today_day_of_year
            message = f"Dear {name}, your birthday in {today.year} is on {month_map[month]} {day}, " \
                      f"and there is {days_until_birthday} days until your birthday!"
        elif today_day_of_year > birthday_day_of_year:
            days_passed = today_day_of_year - birthday_day_of_year
            message = f"Dear {name}, your birthday in {today.year} is on {month_map[month]} {day}, " \
                      f"and {days_passed} days have passed since your birthday."
        else:
            message = f"Dear {name}, your birthday in {today.year} is on {month_map[month]} {day}, " \
                      "which is TODAY! HAPPY BIRTHDAY!"
